...
<head>
    ...
    <link rel="stylesheet" href="wp-content/themes/horizon/assets/css/style.css">
    <link rel="stylesheet" href="wp-content/themes/horizon/assets/css/splide-core.min.css">
...
<body>
                ...
                <div class="header__small__contact d-flex justify-content-end align-items-center d-wrap gap-2">
                    ...
                    <div class="header__small__social">
                        <a href="" class="header__small__social__icon d-flex justify-content-center align-items-center">  
                            ...
                            <path d="M3.08243 5.39593C4.34575 5.39593 5.36987 4.37181 5.36987 3.10849C5.36987 1.84517 4.34575 0.821045 3.08243 0.821045C1.81911 0.821045 0.794983 1.84517 0.794983 3.10849C0.794983 4.37181 1.81911 5.39593 3.08243 5.39593Z" fill="white"/>
                            <path d="M7.52977 7.12929V19.82H11.4701V13.5442C11.4701 11.8882 11.7816 10.2845 13.8349 10.2845C15.8599 10.2845 15.885 12.1778 15.885 13.6487V19.821H19.8274V12.8615C19.8274 9.44287 19.0914 6.81565 15.0957 6.81565C13.1773 6.81565 11.8914 7.86842 11.3655 8.86473H11.3122V7.12929H7.52977ZM1.10862 7.12929H5.05519V19.82H1.10862V7.12929Z" fill="white"/>
                            </svg>
                        </a>
                    </div>
                    <div class="header__small__social">
        ...
        <div class="header__menu d-flex justify-content-between align-items-center">
            <div class="container">
                <div class="header__menu__items d-flex justify-content-between align-items-center">
                    <div class="header_menu__logo d-flex justify-content-center align-items-center">
                        <a href="" class="d-block"><img src="wp-content/themes/horizon/assets/images/logo-horizon.png" alt=""></a>=
                    </div>
                    <div class="header__menu__wrapper">
                        <ul class="header__menu__list d-flex justify-content-center align-items-center">
                            <li class="header__menu__li d-block"><a href="" class="header__menu__link">Modelos</a></li>
                            <li class="header__menu__li d-block"><a href="" class="header__menu__link">Horizon Boats</a></li>
                            <li class="header__menu__li d-block"><a href="" class="header__menu__link">Projetos</a></li>
                            <li class="header__menu__li d-block"><a href="" class="header__menu__link">Contatos</a></li>
                            <li class="header__menu__li d-block"><a href="" class="header__menu__link header__menu__link--cta">Fale conosco</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <section class="slider">
        <img class="slider__img"src="wp-content/themes/horizon/assets/images/img01-slide.webp" alt="">
        <div class="splide slider__carousel">
            ...
            <div class="row">
                <div class="col-12 col-lg-3">
                    <div class="company__numbers">
                        <div class="company__numbers__item d-flex justify-content-center align-items-center">
                            <h2 class="company__numbers__main text-white m-1">10</h2>
                            <p class="company__numbers__description text-white">
                ...
                <div class="col-12 col-lg-3">
                    <div class="company__numbers">
                        <div class="company__numbers__item d-flex justify-content-center align-items-center">
                            <h2 class="company__numbers__main text-white m-1">2K</h2>
                            <p class="company__numbers__description text-white">
                ...
                <div class="col-12 col-lg-3">
                    <div class="company__numbers">
                        <div class="company__numbers__item d-flex justify-content-center align-items-center">
                            <h2 class="company__numbers__main text-white m-1">3K</h2>
                            <p class="company__numbers__description text-white">
                ...
                <div class="col-12 col-lg-3">
                    <div class="company__numbers">
                        <div class="company__numbers__item d-flex justify-content-center align-items-center">
                            <h2 class="company__numbers__main text-white m-1">20</h2>
                            <p class="company__numbers__description text-white">
                                Anos de experiência
                            </p>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6">
                    <div class="history__right">
                        <img class="history__right__img" src="wp-content/themes/horizon/assets/images/history-img.webp" alt="">
                    </div>
                </div>
            </div>
            <div class="history__stage">
                <div class="d-flex">
                    <div class="history__stage__card text-center d-flex flex-column justify-content-center align-items-center d-wrap">
                        <div class="history__stage__line"></div>
                        <h4 class="history__stage__icon d-flex justify-content-center align-items-center">
                            1ª
                        </h4>
                        <h4 class="history__stage__title">
                            Etapa
                        </h4>
                        <p class="history__stage__description">
    ...
    <section class="boats">
        <div class="boats__title m-3">
            <p class="caption-headline text-center">boats</p>
            <h3 class="main-title text-center">nossos modelos</h3>
        </div>
        <div class="boats__model d-flex ">
            <div class="boats__model__card d-flex d-wrap position-relative">
                <img src="wp-content/themes/horizon/assets/images/boat01.webp" alt="" class="boats__model__card__img">
                <h4 class="boats__model__title position-absolute">
                    PILOT BOAT VI
                </h4>
                <p class="boats__model__vertical position-absolute">HORIZON BOAT</p>
            </div>
            <div class="boats__model__card d-flex d-wrap position-relative">
                <img src="wp-content/themes/horizon/assets/images/boat01.webp" alt="" class="boats__model__card__img">
                <h4 class="boats__model__title position-absolute">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-4">
                    ...
                    <h3 class="services__title main-title">CONHEÇA TODOS OS NOSSOS SERVIÇOS</h3>
                ...
                <div class="col-12 col-lg-8">
                    <div class="d-flex">
                        <div class="services__card text-center d-flex flex-column align-items-center justify-content-center d-wrap position-relative">
                            <img src="wp-content/themes/horizon/assets/images/bg-services.png " alt="" class="service__card__bg">
                            <div class="position-absolute">
                                <h4 class="services__card__title">Construção</h4>
                                <p class="services__card__description">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum </p>
                                <a href="" class="services__card__cta button-white d-inline-block">
                                    Saiba mais
                                    <svg class="align-items-center" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="services__card services__card--black text-center d-flex flex-column align-items-center justify-content-center d-wrap position-relative">
                            <img src="wp-content/themes/horizon/assets/images/bg-services.png " alt="" class="service__card__bg">
                            <div class="position-absolute">
                                <h4 class="services__card__title">Reparos</h4>
                                <p class="services__card__description">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum </p>
                                <a href="" class="services__card__cta button-blue d-inline-block">
                                    Saiba mais
                                    <svg class="align-items-center" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M8.4909 5.5818C8.35757 5.44846 8.19078 5.38495 7.99054 5.39125C7.79078 5.39707 7.62424 5.46664 7.4909 5.59998C7.35757 5.73331 7.2909 5.90301 7.2909 6.10907C7.2909 6.31513 7.35757 6.48483 7.4909 6.61816L8.14545 7.2727L5.79999 7.2727C5.59393 7.2727 5.42424 7.34252 5.2909 7.48216C5.15757 7.62131 5.0909 7.79392 5.0909 7.99998C5.0909 8.20604 5.16048 8.37889 5.29963 8.51852C5.43927 8.65767 5.61211 8.72725 5.81817 8.72725L8.14545 8.72725L7.47272 9.39998C7.33939 9.53331 7.27563 9.7001 7.28145 9.90034C7.28775 10.1001 7.35757 10.2666 7.4909 10.4C7.62424 10.5333 7.79393 10.6 7.99999 10.6C8.20605 10.6 8.37575 10.5333 8.50908 10.4L10.4 8.50907C10.5454 8.36361 10.6182 8.19392 10.6182 7.99998C10.6182 7.80604 10.5454 7.63634 10.4 7.49089L8.4909 5.5818ZM7.99999 0.727249C9.00605 0.72725 9.95151 0.91828 10.8364 1.30034C11.7212 1.68192 12.4909 2.19998 13.1454 2.85452C13.8 3.50907 14.3181 4.27877 14.6996 5.16361C15.0817 6.04846 15.2727 6.99392 15.2727 7.99998C15.2727 9.00604 15.0817 9.95149 14.6996 10.8363C14.3181 11.7212 13.8 12.4909 13.1454 13.1454C12.4909 13.8 11.7212 14.3183 10.8364 14.7003C9.95151 15.0819 9.00605 15.2727 7.99999 15.2727C6.99393 15.2727 6.04848 15.0819 5.16363 14.7003C4.27878 14.3183 3.50908 13.8 2.85454 13.1454C2.19999 12.4909 1.68193 11.7212 1.30036 10.8363C0.918296 9.95149 0.727266 9.00604 0.727266 7.99998C0.727266 6.99392 0.918297 6.04846 1.30036 5.16361C1.68193 4.27876 2.19999 3.50907 2.85454 2.85452C3.50908 2.19998 4.27878 1.68192 5.16363 1.30034C6.04848 0.91828 6.99393 0.727249 7.99999 0.727249ZM7.99999 2.18179C6.38787 2.18179 5.01502 2.74834 3.88145 3.88143C2.74836 5.01501 2.18181 6.38786 2.18181 7.99998C2.18181 9.6121 2.74836 10.9849 3.88145 12.1185C5.01502 13.2516 6.38787 13.8182 7.99999 13.8182C9.61211 13.8182 10.9847 13.2516 12.1178 12.1185C13.2514 10.9849 13.8182 9.6121 13.8182 7.99998C13.8182 6.38786 13.2514 5.01501 12.1178 3.88143C10.9847 2.74834 9.61212 2.18179 7.99999 2.18179Z" fill="#ffffff"/>
                                    </svg>
                                </a>
                            </div>
                        </div>
                        <div class="services__card text-center d-flex flex-column align-items-center justify-content-center d-wrap position-relative">
                            <img src="wp-content/themes/horizon/assets/images/bg-services.png " alt="" class="service__card__bg">
                            <div class="position-absolute">
                                <h4 class="services__card__title">Projetos Personalizados</h4>
                                <p class="services__card__description">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum </p>
                                <a href="" class="services__card__cta button-white d-inline-block">
                                    Saiba mais
                                    <svg class="align-items-center" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <script src="wp-content/themes/horizon/assets/js/vendor.min.js"></script>
</body>
</html>